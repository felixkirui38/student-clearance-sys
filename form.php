                    ...
                    <div class="card-body">
                        ...
                        <form action="code.php" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="checkbox" name="brands[]" value="HDS" required> HDS <br><br>
                                ...
                                <input type="checkbox" name="brands[]" value="DEAN(Business)" required> Business Department <br><br>
                                 ...
                                 <input type="checkbox" name="brands[]" value="DEAN(SSAT)" required>  DEAN(SSAT)<br><br>
                                 ...
                                 <input type="checkbox" name="brands[]" value="Estates" required> Estates <br><br>
                                 <input type="checkbox" name="brands[]" value="Comtech" required> Comtech <br><br>
